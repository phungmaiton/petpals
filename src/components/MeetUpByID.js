      ...
      <section className="pt-[40px] pb-[80px] lg:pt-[40px] lg:pb-[30px] relative overflow-hidden">
          ...
          <div className="grid lg:grid-cols-12 grid-cols-1 items-center">
            ...
            <div className="lg:col-span-8 text-center mb-[50px] lg:mb-0">
              <div className="meetup-cover">
                <img src="https://s3-us-west-1.amazonaws.com/assets.wagwalkingweb.com/media/daily_wag/blog_articles/hero/1652991813.2952871/where-to-find-dog-meetup-groups-and-events-near-you-2.png" />
              </div>
            </div>
            {/* EVENT INFO 
            ----------------*/}
              ...
              <div className="min-h-[300px]">
                <div className="meetup-info">
                  <ul>
                    ...
                    <li>
                      <strong>Venue:</strong> Rock Hill District Park
                      <br />
                      15150 Old Lee Rd
                      <br />
                      Chantilly, VA 20151
                ...
                <div className="button-group">
                  <div className="pt-2 lg:flex pr-[10px]">
                    <button className="px-btn px-btn-theme" to="signup">
                      Attend
                    </button>
                  </div>
                  <div className="pt-2 lg:flex">
                    <button className="px-btn px-btn-dark" to="signup">
                      event chat
                    </button>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-10">
          <div className="grid lg:grid-cols-12 grid-cols-1 items-center">
            ...
            ----------------*/}
              <div className="chat">
                <h1>maybe the chat goes here not sure lol</h1>
              </div>
            </div>
          </div>
        </div>
