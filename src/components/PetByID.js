...
export default function PetByID({
    user,
    pets,
    onLogin
}) {
    ...
    return (
        <PageTransition>
          <section className="pt-[120px] pb-[50px] lg:pt-[130px] lg:pb-[30px] bg-blue relative overflow-hidden">
            <div className="container mx-auto px-10">
                  ...
                  <div className="min-h-[300px]">
                    <div className="meetup-info">
                      ...
                      <ul>
                        ...
                        <li>
                          <strong>Located in:</strong> {pet.city}, {pet.state}, {pet.country}
                        </li>
                        <li>
